package com.sgaraba.store.repository;

import com.sgaraba.store.JhipsterApp;
import com.sgaraba.store.config.Constants;
import com.sgaraba.store.config.audit.AuditEventConverter;
import com.sgaraba.store.domain.PersistentAuditEvent;
...
import static com.sgaraba.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
